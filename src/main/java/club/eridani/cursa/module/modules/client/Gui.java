...
public class Gui extends ModuleBase {
    ...
    public Setting<Integer> red = setting("Red", 255, 0, 255).whenFalse(rainbow);
    public Setting<Integer> green = setting("Green", 255, 0, 255).whenFalse(rainbow);
    public Setting<Integer> blue = setting("Blue", 0, 0, 255).whenFalse(rainbow);
