...
public class ConfigManager {
    ...
    private static final String CONFIG_PATH = "Lemonade/config/";
    private static final Gson gsonPretty = new GsonBuilder().setPrettyPrinting().create();
    private static final JsonParser jsonParser = new JsonParser();

    private final File CLIENT_FILE = new File(CONFIG_PATH + "Lemonade.json");
    private final File GUI_FILE = new File(CONFIG_PATH + "Lemonade_GUI.json");
    private final File MODULE_FILE = new File(CONFIG_PATH + "Lemonade_Module.json");
